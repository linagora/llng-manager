...
import OidcRPMetaDataNodeForm from "./OidcRPMetaDataNodeForm";

export default function OidcRPMetaDataNodeContainerForm({
  node,
  dispatch,
}: {
              ...
              <tr key={i}>
                ...
                <td>
                  <IconButton
                    onClick={() => {
                      dispatch(
                        delApp({ name: child.data.name || "", type: "RPoidc" })
                      );
                    }}
                    className="minus"
                  >
